...
async function getList() {
    ...
    const myCardList = ["圣殿斥候1", "箭竹守卫", "树木之怒", "飓风术", "长耳庄巧姑", "圣殿弩手", "增援战线", "连击1", "执剑道者", "龟族僧人",
        "铁山靠", "风卷残云1", "风卷残云2", "光明惩戒1", "四芒军旗", "圣殿御卫", "冲锋装备", "御风武者", "夺取阵地", "墨轩隐士",
        "万物之灵", "禁卫指挥官", "花光春影·安娜贝尔", "百花长枪·卡罗琳", "明日香·露娜", "九天玄女·轩", "上宝沁金耙", "永恒之王·莱哈特", "白袍·伊恩", "武圣·云长"];
