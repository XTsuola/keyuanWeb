...
import chanyigu from "./cardList/taotailangCard/chanyigu.json";
import manshikuangye from "./cardList/taotailangCard/manshikuangye.json";
import yinmizhe from "./cardList/taotailangCard/yinmizhe.json";
...
async function getList() {
    ...
    let allData: any = [...chanyigu, ...manshikuangye, ...yinmizhe];
    if (formState.name) {
