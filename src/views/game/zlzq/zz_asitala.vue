...
async function getList() {
    ...
    const myCardList = ["圣殿斥候1", "学仆-观测型", "方尖魔碑", "天使琼浆", "沉重否定", "全数否定", "圣殿弩手", "塔楼弓手", "增援战线", "虚化术",
        "光明惩戒1", "隐形术", "圣殿御卫", "破魔系教授", "克隆术", "学仆-脉冲型1", "学仆-脉冲型2", "学仆-脉冲型3", "冲锋装备", "幻域秘树",
        "夺取阵地", "观星台大预言家", "惩戒天使", "禁卫指挥官", "米拉方舟", "花光春影·安娜贝尔", "百花长枪·卡罗琳", "明日香·露娜", "月之神·米拉", "白袍·伊恩"];
