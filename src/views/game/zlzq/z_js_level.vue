...
import simangdiguo from "./cardList/jiaoshouCard/simangdiguo.json";
import chanyigu from "./cardList/jiaoshouCard/chanyigu.json";
import yinmizhe from "./cardList/jiaoshouCard/yinmizhe.json";
