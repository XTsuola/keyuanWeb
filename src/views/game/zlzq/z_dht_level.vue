...
import manshikuangye from "./dahetaoCard/manshikuangye.json";
import yinmizhe from "./dahetaoCard/yinmizhe.json";
import simangdiguo from "./dahetaoCard/simangdiguo.json";
import chanyigu from "./dahetaoCard/chanyigu.json";
