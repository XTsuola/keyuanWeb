<template>
    <div class="childMain">
        <a-form ref="heroAdd" style="width: 100%;" :model="addData" name="basic" :label-col="{ span: 4 }"
            ...
            <a-form-item label="性别" name="genter" :rules="[{ required: true, message: '请选择英雄性别!' }]">
                <a-select v-model:value="addData.genter">
                    <a-select-option :value="1">男</a-select-option>
                    <a-select-option :value="0">女</a-select-option>
                </a-select>
            </a-form-item>
            <a-form-item label="体型" name="figure" :rules="[{ required: true, message: '请选择体型!' }]">
                <a-select v-model:value="addData.figure">
            ...
            <a-form-item label="星级" name="star" :rules="[{ required: true, message: '请选择英雄星级!' }]">
                <a-select v-model:value="addData.star">
            ...
            <a-form-item label="元素" name="element" :rules="[{ required: true, message: '请选择元素类型!' }]">
                <a-select v-model:value="addData.element">
